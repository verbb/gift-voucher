...
class Pdf extends Component
{
    ...
    public function renderPdf(array $codes, ?Order $order = null, ?LineItem $lineItem = null, mixed $option = '', mixed $templatePath = null): string
    {
        ...
        $dompdfTempDir = $tempPath . DIRECTORY_SEPARATOR . 'gift_voucher_dompdf';
        $dompdfFontCache = $tempPath . DIRECTORY_SEPARATOR . 'gift_voucher_dompdf';
        $dompdfLogFile = $tempPath . DIRECTORY_SEPARATOR . 'gift_voucher_dompdf.htm';
