...
class GiftVoucher_DownloadsController extends BaseController
{
    // Properties
    // =========================================================================
    ...
    public function actionPdf()
    {
        ...
        $filenameFormat = GiftVoucherHelper::getPlugin()->getSettings()->voucherCodesPdfFilenameFormat;
        ...
        if (!$codes) {
            throw new HttpException(404, 'Voucher codes does not exist.');
        }
