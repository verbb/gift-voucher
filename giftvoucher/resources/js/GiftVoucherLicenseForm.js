...
Craft.GiftVoucher.LicenseForm = Craft.BaseElementIndex.extend({
    licenseKey: null,
    ...
    loadLicenseInfo: function(action) {
        Craft.postActionRequest('giftVoucher/license/getLicenseInfo', $.proxy(function(response, textStatus) {
    ...
    handleUnregisterLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('giftVoucher/license/unregister', $.proxy(function(response, textStatus) {
    ...
    handleUpdateLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('giftVoucher/license/updateLicenseKey', data, $.proxy(function(response, textStatus) {
    ...
    handleTransferLicenseFormSubmit: function(ev) {
        ...
        Craft.postActionRequest('giftVoucher/license/transfer', $.proxy(function(response, textStatus) {
